            ...
            <div class="d-flex align-items-center">
                ...
                <div class="profile circular-image" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Hello, {{ Auth::user()->fname }}">
                        <a class="navbar-brand" href="./profile">
                            <img src="{{ asset('uploads/' . (Auth::user()->image ?? 'default.png')) }}" alt="">
                        </a>
                    </div>
                @endif
            </div>
    ...
    <div id="wrapper" class="d-flex">
        ...
        <nav id="sidebar">
            <ul class="navbar-nav">
                ...
                <li title="Users" class="nav-item ps-2">
                    <a href="./view" class="nav-link active text-white" aria-current="page">
                        <i class="fa-solid fa-users pe-3"></i>
                        <span class="sidebar-item pe-3">View Users<span>
                    </a>
                </li>
            
            <li title="Add a Pet" class="nav-item ps-2">
                <a href="./logs" class="nav-link active text-white pe-3" aria-current="page">
                    <i class="fa-solid fa-paw pe-2"></i>
                    <span class="sidebar-item pe-3">Pet Logs</span>
                </a>
            </li>
