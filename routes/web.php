...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/logs', [PetsController::class, 'showLogs'])->name('pets.pet-logs');
});
...
Route::middleware(['auth', 'auth_admin'])->group(function () {
    ...
    Route::middleware(['auth', 'auth_admin'])->get('/users/view', [UsersController::class, 'index'])->name('users.view');
    ...
    Route::get('/pets/{pet}/activities', [PetsController::class, 'activities'])->name('pets.activities');
});
